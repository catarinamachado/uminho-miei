/**
 * Classe Automoveis, subclasse de AtividadesEconomicas.
 *
 * @author A81047
 * @author A34900
 * @author A82339
...
public class Automoveis extends AtividadesEconomicas implements Serializable {

    public static final Automoveis objeto = new Automoveis();
    /**
     * Construtor por omissão
     */
    public Automoveis() {
        super(6, "Automoveis", 0.05, new BigDecimal(100));
    }

    /**
     * Construtor cópia
     */
    public Automoveis(Automoveis atividade) {
